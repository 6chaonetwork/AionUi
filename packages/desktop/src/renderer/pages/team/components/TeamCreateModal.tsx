...
const AgentRadioRow: React.FC<{
  ...
  <div
    className={`team-create-agent-option flex cursor-pointer items-center gap-12px rounded-8px px-12px py-9px transition-colors ${
      isSelected ? 'team-create-agent-option--selected bg-aou-1' : 'hover:bg-fill-2'
    }`}
